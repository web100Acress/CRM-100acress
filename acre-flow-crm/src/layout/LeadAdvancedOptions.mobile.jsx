  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto p-0">
        <DialogHeader className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 rounded-lg border border-purple-200">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full flex items-center justify-center">
                <span className="text-white text-lg font-bold">{getInitials(lead.name)}</span>
              </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
          >
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{lead.property}</p>
                </div>
                <div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <PhoneCall size={20} className="text-green-600 mb-2" />
              ...
              <button
                ...
                className="flex flex-col items-center justify-center p-4 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors"
              >
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-xs mt-1">Hot</p>
                </div>
              </button>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-xs mt-1">Warm</p>
                </div>
              </button>
              ...
              >
                <div className="text-center">
                  <span className="text-lg">❄️</span>
                  <p className="text-xs mt-1">Cold</p>
                </div>
              </button>
            </div>
          </div>
          ...
          {/* Analytics Section */}
          <div className="space-y-3">
            <h4 className="font-semibold text-gray-900">Call History & Follow-up Analytics</h4>

...
const LeadTable = ({ userRole }) => {
    ...
    const fetchAssignableUsers = async () => {
      try {
        ...
        const response = await fetch(
          "https://crm.100acress.com/api/api/leads/assignable-users",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  const handleDeleteLead = async (leadId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`https://crm.100acress.com/api/api/leads/${leadId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleViewFollowUps = async (lead) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://crm.100acress.com/api/api/leads/${lead._id}/followups`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handleForwardLead = async (leadId) => {
    try {
      ...
      const token = localStorage.getItem("token");
      const res = await fetch(
        `https://crm.100acress.com/api/api/leads/${leadId}/forward`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (res.ok) {
        ...
        const leadsResponse = await fetch("https://crm.100acress.com/api/api/leads", {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
          },
                      ...
                      <select
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            const token = localStorage.getItem("token");
                            await fetch(
                              `https://crm.100acress.com/api/api/leads/${lead._id}`,
                              {
                                method: "PUT",
                                headers: {
                                  "Content-Type": "application/json",

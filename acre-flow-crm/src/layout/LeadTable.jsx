...
const LeadTable = ({ userRole }) => {
  ...
  useEffect(() => {
    const fetchLeads = async () => {
      try {
        ...
        const response = await fetch("http://13.233.167.95:5001/api/leads", {
          headers: {
    ...
    const fetchAssignableUsers = async () => {
      try {
        ...
        const response = await fetch(
          "http://13.233.167.95:5001/api/leads/assignable-users",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  const handleDeleteLead = async (leadId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`http://13.233.167.95:5001/api/leads/${leadId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleViewFollowUps = async (lead) => {
    ...
    try {
      ...
      const res = await fetch(
        `http://13.233.167.95:5001/api/leads/${lead._id}/followups`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handleForwardLead = async (leadId) => {
    try {
      ...
      const token = localStorage.getItem("token");
      const res = await fetch(
        `http://13.233.167.95:5001/api/leads/${leadId}/forward`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (res.ok) {
        ...
        const leadsResponse = await fetch("http://13.233.167.95:5001/api/leads", {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
          },
                  ...
                  <select
                    ...
                    onChange={async (e) => {
                      ...
                      try {
                        const token = localStorage.getItem("token");
                        await fetch(
                          `http://13.233.167.95:5001/api/leads/${lead._id}`,
                          {
                            method: "PUT",
                            headers: {
                              "Content-Type": "application/json",

  ...
  const SuperAdminProfile = () => {
    ...
    useEffect(() => {
      ...
      setSocket(s);
      // Fetch dashboard stats and recent activity in real time
    ...
    const leadStatusData = Object.entries(dashboardStats.leadsByStatus || {}).map(([status, count]) => ({ name: status.charAt(0).toUpperCase() + status.slice(1), value: count }));
        ...
        <div className="superadmin-container">
          ...
          <div className="stats-grid">
            ...
            {leadStatusData.length > 0 && (
              <Card className="stat-card" style={{ minWidth: 320, minHeight: 260, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

                            ...
                            >
                              ...
                              <td className="hidden lg:table-cell px-3 py-3 whitespace-nowrap text-sm text-gray-800">
                                <div className="flex items-center">
                                  <select
                                    className={`px-2 py-1 border rounded-full text-xs focus:outline-none focus:ring-2 focus:ring-red-500 ${getRoleClasses(item.role)} ${updatingRole[userId]
                              ...
                              <td className="hidden lg:table-cell px-3 py-3 whitespace-nowrap text-sm text-gray-800">
                                <div className="flex items-center gap-2">
                                  <span
                                    className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-full ${item.emailVerified
                              ...
                              <td className="px-3 py-3 whitespace-nowrap text-center text-sm font-medium">
                                <div className="flex flex-col sm:flex-row gap-2 justify-center">
                                  ...
                                  <button
                                    onClick={() => navigate('/whatsapp-chat', { state: { contact: item } })}
                                    className="px-3 py-1.5 sm:px-3 sm:py-1.5 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors text-xs sm:text-xs w-full sm:w-auto"
                                  >
                                    WhatsApp
                                  </button>
                                  {getTelHref(item.mobile) ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <select
                          className={`px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 ${getRoleClasses(selectedUser.role)} ${updatingRole[selectedUser._id]
                              ? "opacity-60 cursor-not-allowed"
                              : ""
                            }`}
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span
                          className={`inline-flex items-center px-3 py-1 text-sm font-medium rounded-full ${selectedUser.emailVerified
                              ? "bg-green-100 text-green-800"
                              : "bg-red-100 text-red-800"
                            }`}
                        >

...
import EmployeeManagement from '@/features/hr/components/EmployeeManagement';
import Recruitment from '@/features/hr/components/Recruitment';
import SalaryManagement from '@/features/hr/components/SalaryManagement';
import Attendance from '@/features/hr/components/Attendance';
import PerformanceReview from '@/features/hr/components/PerformanceReview';
import ExpenseManagement from '@/features/hr/components/ExpenseManagement';
import Reports from '@/features/hr/components/Reports';
import HrSettings from '@/features/hr/components/HrSettings';

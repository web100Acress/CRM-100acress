...
import { Eye, EyeOff, Mail, Lock, Home, Code, Briefcase, Monitor, Building, MapPin, Key, Users, TrendingUp, Shield } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-red-700 to-red-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <img src="/image/100acress icon.png" alt="100acres Logo" className="fixed top-0.5 left-12 w-40 h-40 object-contain z-50" />
      {/* Floating Property Theme Background */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Animated Property Icons */}
        <div className="absolute top-20 left-20 w-16 h-16 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-bounce" style={{animationDelay: '0s', animationDuration: '3s'}}>
          <Home className="w-8 h-8 text-white opacity-60" />
        </div>
        <div className="absolute top-40 right-32 w-14 h-14 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-pulse" style={{animationDelay: '1s', animationDuration: '4s'}}>
          <Building className="w-7 h-7 text-white opacity-60" />
        </div>
        <div className="absolute top-60 left-1/4 w-12 h-12 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-bounce" style={{animationDelay: '2s', animationDuration: '3.5s'}}>
          <Key className="w-6 h-6 text-white opacity-60" />
        </div>
        <div className="absolute bottom-32 right-20 w-18 h-18 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-pulse" style={{animationDelay: '0.5s', animationDuration: '4.5s'}}>
          <MapPin className="w-8 h-8 text-white opacity-60" />
        </div>
        <div className="absolute bottom-60 left-32 w-14 h-14 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-bounce" style={{animationDelay: '1.5s', animationDuration: '3s'}}>
          <Users className="w-7 h-7 text-white opacity-60" />
        </div>
        <div className="absolute top-32 right-1/4 w-16 h-16 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-pulse" style={{animationDelay: '2.5s', animationDuration: '4s'}}>
          <TrendingUp className="w-8 h-8 text-white opacity-60" />
        </div>
        <div className="absolute bottom-20 right-1/3 w-12 h-12 bg-white bg-opacity-10 rounded-2xl flex items-center justify-center animate-bounce" style={{animationDelay: '3s', animationDuration: '3.5s'}}>
          <Shield className="w-6 h-6 text-white opacity-60" />
        </div>
        
        {/* Large Background Shapes */}
        <div className="absolute top-10 right-10 w-32 h-32 bg-white bg-opacity-5 rounded-full animate-pulse" style={{animationDuration: '6s'}}></div>
        <div className="absolute bottom-10 left-10 w-40 h-40 bg-white bg-opacity-5 rounded-full animate-pulse" style={{animationDelay: '3s', animationDuration: '8s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white bg-opacity-5 rounded-full animate-pulse" style={{animationDelay: '4s', animationDuration: '10s'}}></div>
        
        {/* Floating Property Cards */}
        <div className="absolute top-16 left-1/3 w-24 h-16 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm animate-float" style={{animationDelay: '1s'}}>
          <div className="p-2 text-center">
            <Home className="w-4 h-4 text-white opacity-60 mx-auto mb-1" />
            <div className="text-xs text-white opacity-60">Villa</div>
          </div>
        </div>
        <div className="absolute bottom-32 right-1/4 w-24 h-16 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm animate-float" style={{animationDelay: '2s'}}>
          <div className="p-2 text-center">
            <Building className="w-4 h-4 text-white opacity-60 mx-auto mb-1" />
            <div className="text-xs text-white opacity-60">Flat</div>
          </div>
        </div>
        <div className="absolute top-1/3 right-16 w-24 h-16 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm animate-float" style={{animationDelay: '3s'}}>
          <div className="p-2 text-center">
        ...
        <div className="hidden lg:flex flex-col items-start space-y-8 text-white max-w-lg">
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-4xl font-bold tracking-tight">100acres.com</h1>
            </div>
            <p className="text-2xl font-semibold text-red-100">Rishto Ki Shuruwat</p>
            <p className="text-lg text-red-200 leading-relaxed">
              India's Best Property Site. Post and Search Your Property with confidence and ease.
            </p>
          </div>
          ...
          <div className="bg-white bg-opacity-95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white border-opacity-20">
            ...
            <div className="lg:hidden mt-8 pt-6 border-t border-gray-200 text-center">
              <p className="text-gray-600 text-sm">
                <span className="font-semibold text-red-600">100acres.com</span> - Rishto Ki Shuruwat
              </p>
            </div>
          </div>
        </div>
      ...
      {showForgotModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            {forgotStatus && (
              <div className={`mt-4 p-3 rounded-lg ${forgotStatus.includes("sent") ? "bg-green-50 text-green-600" : "bg-red-50 text-red-600"}`}>
